/**
 * Turntable.fm Auto Awexome Script
  ...
  window.bdub = $.extend(window.bdub, {
    ...
    init: function() {
      $('.roomView').ready(function() {
        ...
        window.bdub.botMessage = $('<div id="bot-message">B^Dub\'s Auto Awexome. <span style="font-style: italic;"></span> <a href="#" style="text-decoration: none; color: yellow; font-weight: bold;">Turn off</a></div>');
